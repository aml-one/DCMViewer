...
public partial class MainWindow : Window
{
    ...
    private void ViewModelOnPropertyChanged(object? sender, PropertyChangedEventArgs e)
    {
        if (string.Equals(e.PropertyName, nameof(MainViewModel.ModelGroup), StringComparison.Ordinal))
        {
            ...
            if (!_viewModel.IsSectionMode)
            {
                RefreshSectionReferenceFromBounds(GetVisibleBounds());
            }
            else
            {
    ...
    private void UpdateClippingToggleButtonState()
    {
        ...
        clippingToggleButton.ToolTip = _isNearClippingRelaxed
            ...
            : "Relax near clipping";
        clippingToggleButton.Content = CreateToolbarIcon("Images/clipping.png");
    ...
    private void UpdateProjectionToggleButtonState()
    {
        ...
        projectionToggleButton.Content = CreateToolbarIcon(_isOrthographicView ? "Images/perspective.png" : "Images/perspective.png");
    }
    ...
    private void UpdateZoomPercentLabel()
    {
        ...
        if (camera is OrthographicCamera orthographicCamera)
        {
            ...
            if (_zoomReferenceOrthographicWidth < 1e-9)
            {
                _zoomReferenceOrthographicWidth = currentWidth;
            }

            var orthographicZoomPercent = (_zoomReferenceOrthographicWidth / currentWidth) * 100.0;
    ...
    private void UpdateToolButtonStates()
    {
        ...
        SectionToggleButton.Content = CreateToolbarIcon(_viewModel.IsSectionMode ? "Images/turnoffsection.png" : "Images/sectionmode.png");
