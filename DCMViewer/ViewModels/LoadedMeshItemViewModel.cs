...
public sealed class LoadedMeshItemViewModel : INotifyPropertyChanged
{
    ...
    {
        MeshCategory.Model => "Images/model.png",
        MeshCategory.Scan => "Images/scan.png",
        MeshCategory.Restoration => "Images/restoration.png",
        MeshCategory.Abutment => "Images/abutment.png",
        _ => "Images/model.png"
    };
    ...
    public static LoadedMeshItemViewModel CreateFailed(string filePath, string error)
    {
